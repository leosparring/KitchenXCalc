...
APPLIANCES = {
    "Fryer":                   {"icon": "", "input_type": "wl",      "typical_w": 400, "typical_d": 600, "max_area": 0.137, "max_side": 380, "abs_max_area": 0.55, "nozzle": "2–30",  "flow": 2},
    "Fryer with drip board":   {"icon": "", "input_type": "wl_drip", "typical_w": 550, "typical_d": 600, "typical_drip": 150, "max_area": None, "max_side": None, "max_area_body": 0.137, "max_side_body": 380, "max_area_drip": 0.1945, "max_side_drip": 540, "abs_max_area": 0.55, "nozzle": "2–30",  "flow": 2},
    "Griddle":                 {"icon": "", "input_type": "wl",      "typical_w": 600, "typical_d": 500, "max_area": 0.578, "max_side": 760, "nozzle": "1–60",  "flow": 1},
    "Gas or electric broiler": {"icon": "", "input_type": "wl",      "typical_w": 600, "typical_d": 550, "max_area": 0.561, "max_side": 920, "nozzle": "1–60",  "flow": 1},
    "Range top":               {"icon": "", "input_type": "wl",      "typical_w": 600, "typical_d": 600, "max_area": None,  "distance": 270,   "nozzle": "2–60",  "flow": 2},
    "Wok":                     {"icon": "", "input_type": "d",       "typical_dia": 500,                 "max_area": 0.30,  "abs_max_dia": 410, "nozzle": "2–30",  "flow": 2},
    "Tilt skillet":            {"icon": "", "input_type": "wl",      "typical_w": 800, "typical_d": 700, "max_area": 0.1945,                 "nozzle": "2–30",  "flow": 2},
    "Circular duct":           {"icon": "", "input_type": "d",       "typical_dia": 400,                 "max_area": None, "max_dia": 404, "max_perim": 1270,  "nozzle": "1–110", "flow": 1},
    "Rectangular duct":        {"icon": "",  "input_type": "wl",      "typical_w": 600, "typical_d": 300, "max_area": None, "max_perim": 1270,                  "nozzle": "1–110", "flow": 1},
    "Plenum":                  {"icon": "", "input_type": "wl",      "typical_w": 800, "typical_d": 500, "max_area": None, "max_width": 600, "max_length": 3000, "abs_max_width": 600, "nozzle": "1–60",  "flow": 1},
    "Plenum V-style":          {"icon": "", "input_type": "wl",      "typical_w": 800, "typical_d": 500, "max_area": None, "max_width": 600, "max_length": 3000, "min_cols": 2, "abs_max_width": 1200, "nozzle": "1–60",  "flow": 1},
}
...
NOZZLE_PLACEMENT = {'Fryer': 'Nozzle placed 690 to 1200 mm above the section, aiming at the section centre.', 'Fryer with drip board': 'Nozzle placed 690 to 1200 mm above the section, aiming at the section centre.', 'Wok': 'Nozzle placed 690 to 1200 mm above the section, aiming at the section centre.', 'Tilt skillet': 'Nozzle placed 690 to 1200 mm above the section, aiming at the section centre.', 'Griddle': 'Nozzle placed 760 to 1020 mm above the section, 0 to 50 mm from the perimeter, aiming at the section centre.', 'Gas or electric broiler': 'Nozzle placed 500 to 1020 mm above the section, aiming at the section centre.', 'Range top': 'Nozzle placed centrally above section at 690 to 1020 mm, aiming straight down.', 'Plenum': 'Nozzle placed at the start of the plenum, 50 to 100 mm from the filters, aiming horizontally.', 'Plenum V-style': 'Nozzle placed at the start of the plenum, 50 to 100 mm from the filters, aiming horizontally.', 'Circular duct': 'Nozzle placed centrally in the section, 50 to 200 mm into the duct, aiming straight up.', 'Rectangular duct': 'Nozzle placed centrally in the section, 50 to 200 mm into the duct, aiming straight up.'}
...
app_ui = ui.page_fluid(
    ...
    ui.div(
        ...
        ui.div(
            {"class": "header"},
            ui.tags.h1(ui.HTML("KitchenX <em>Calculation Tool</em>")),
